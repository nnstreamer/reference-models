...
/*-------------------------------------------
                  Functions
-------------------------------------------*/
void vnn_ReleaseNeuralNetwork
    (
    vsi_nn_graph_t *graph
    )
{
    vnn_ReleaseYolov3( graph, TRUE );
...
vsi_status vnn_PostProcessNeuralNetwork
    (
    vsi_nn_graph_t *graph
    )
{
    return vnn_PostProcessYolov3( graph );
}

#define BILLION                                 1000000000
vx_uint64 get_perf_count()
{
...
vsi_status vnn_PreProcessNeuralNetwork
    (
    vsi_nn_graph_t *graph,
    int argc,
    char **argv
    )
{
    ...
    if(vnn_UseImagePreprocessNode())
    {
        return vnn_PreProcessYolov3_ImageProcess(graph, inputs, input_num);
    }
    return vnn_PreProcessYolov3( graph, inputs, input_num );
}

vsi_nn_graph_t *vnn_CreateNeuralNetwork
    (
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov3(data_file_name, NULL);
